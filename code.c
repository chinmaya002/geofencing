...
const float maxDistance = 20;//set the diameter
float initialLatitude = ;  //enter initial latitude
float initialLongitude = ; //enter initial longitude
...
void loop() {
 ...
 //.....................................................................................
  ...
  if(distance > maxDistance)
   {
    Serial.println("outside bus stand");
    lcd.clear();
    st="left";
    lcd.setCursor(0,1);
    lcd.print("  outside the bus  ");
    lcd.setCursor(0,2);
    lcd.print("       stand       ");
    delay(3000);
   ...
   {
    Serial.println("inside bus stand");
    lcd.clear();
    st="entered";
    lcd.setCursor(0,1);
    lcd.print("  inside the bus   ");
    lcd.setCursor(0,2);
    lcd.print("       stand       ");
    delay(3000);
   }
